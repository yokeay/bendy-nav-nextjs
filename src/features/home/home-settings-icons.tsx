...
// Bottom bar icons - linear style with weight and substance
// These are used in the bottom bar (sidebar when position=bottom)

export const IconBottomUser = (p: SvgProps): ReactElement => (
  <svg className={p.className} style={p.style} width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
    <circle cx="12" cy="8" r="4" />
    <path d="M20 21a8 8 0 1 0-16 0" />
  </svg>
);

export const IconBottomHome = (p: SvgProps): ReactElement => (
  <svg className={p.className} style={p.style} width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
...
export const IconBottomLaunchpad = (p: SvgProps): ReactElement => (
  <svg className={p.className} style={p.style} width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
...
// Page management icon - grid of 4 squares representing app pages
export const IconPages = wrap("M3 7h4v4H3z|M3 13h4v4H3z|M9 7h4v4H9z|M9 13h4v4H9z|M15 7h4v4h-4z|M15 13h4v4h-4z");
// Launchpad icon - grid with dots like Apple Launchpad
export const IconLaunchpad = wrap("M3 3h4v4H3z|M3 9h4v4H3z|M3 15h4v4H3z|M9 3h4v4H9z|M9 9h4v4H9z|M9 15h4v4H9z|M15 3h4v4h-4z|M15 9h4v4h-4z|M15 15h4v4h-4z");
...
export const SettingsSvgIcon: Record<string, (p: SvgProps) => ReactElement> = {
  ...
  bottomUser: IconBottomUser,
  bottomHome: IconBottomHome,
  bottomLaunchpad: IconBottomLaunchpad,
};
